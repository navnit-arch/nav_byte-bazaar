namespace AzureIntelligentSupplyChain.Infrastructure.Extensions;
...
using AzureIntelligentSupplyChain.Infrastructure.Persistence.MongoDb;
using AzureIntelligentSupplyChain.Infrastructure.Configuration;
using AzureIntelligentSupplyChain.Core.Domain.Interfaces;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped(sp =>
        {
            ...
            return new MongoDbContext(mongoClient, mongoDbOptions.DatabaseName);
        });
        ...
        IConfiguration configuration)
    {
        ...
        // Add AutoMapper - scan current assembly for profiles
        ...
        IConfiguration configuration)
    {
        Log.Logger = new LoggerConfiguration()
            ...
            .Enrich.WithProperty("Application", "AzureIntelligentSupplyChain")
            .CreateLogger();

        services.AddSerilog();

        // Add Application Insights if connection string is present
    ...
    public static IServiceCollection AddSwagger(this IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(c =>
        {
            ...
            {
                Title = "Azure Intelligent Supply Chain API",
                Version = "v1",
                Description = "Enterprise-grade Supply Chain Management Platform API",
                Contact = new OpenApiContact
                {
                    Name = "Architecture Team",
                    Url = new Uri("https://github.com/navnit-arch")
                },
